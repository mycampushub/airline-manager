  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-[calc(100%-1rem)] max-w-[calc(100%-2rem)] max-h-[95vh] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-4 sm:p-6 shadow-lg duration-200 overflow-hidden",
          "sm:max-w-lg sm:max-h-[85vh]",
          className
        )}
        {...props}
      >
        <div className="overflow-y-auto max-h-[calc(95vh-8rem)] sm:max-h-[calc(85vh-8rem)]">
          {children}
        </div>
        {showCloseButton && (
